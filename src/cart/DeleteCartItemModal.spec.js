...
describe("Basic rendering and Funtionality" , () => {
    ...
    it("Should display the title , message , button" , () =>{
            const deleteModal=  render(<DeleteCartItemModal open={open} onClose = {onClose} handleDelete={handleDelete}/>)
    ...
    it("Proceed Delete operation When delete button is clicked" , () => {
        const deleteModal=  render(<DeleteCartItemModal open={open} handleClose= {onClose} handleDelete={handleDelete} index = {index}/>)
